...
All we need to do is accessed the repository that has file named <i>[intro.py](https://github.com/Octoversity-Admissions/Admissions-Test/blob/main/intro.py)</i>
we need to run that then you got the output like this,
